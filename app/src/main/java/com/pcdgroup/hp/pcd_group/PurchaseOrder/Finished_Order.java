...
public class Finished_Order extends AppCompatActivity implements CallBackInterface {
...
//    menu.add(0, 1, 1, menuIconWithText(getResources().getDrawable(R.drawable.edit), getResources().getString(R.string.action_edit)));
                ...
                alertDialogBuilder.setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (boolean_permission) {
                            progressDialog = new ProgressDialog(Finished_Order.this);
                        ...
                        urlQry = DataGetUrl.COMPLETE_ORDER;
    ...
    private void fn_permission() {
        if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)||
            ...
            if ((ActivityCompat.shouldShowRequestPermissionRationale(Finished_Order.this, Manifest.permission.READ_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(Finished_Order.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);
            }

            if ((ActivityCompat.shouldShowRequestPermissionRationale(Finished_Order.this, Manifest.permission.WRITE_EXTERNAL_STORAGE))) {
            } else {
                ActivityCompat.requestPermissions(Finished_Order.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                        REQUEST_PERMISSIONS);
            }
        } else {
    ...
    public void ExecuteQueryResult(String response,DataGetUrl dataGetUrl) {
        Toast.makeText(Finished_Order.this, response.toString(), Toast.LENGTH_LONG).show();
    }
}
